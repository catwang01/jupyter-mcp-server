...
class InsertCellTool(BaseTool):
    ...
    @staticmethod
    def _resolve_insert_index(cells, *, cell_id=None, insert_position="after"):
    ...
    async def _insert_cell_ydoc(
        ...
        *,
        ...
        Args:
            ...
            cell_id: Stable cell ID to insert relative to (nbformat 4.5+)
            insert_position: "before" or "after" the cell identified by cell_id
        ...
        if nb:
            ...
            # Resolve cell_id to concrete index if provided
            if cell_id is not None:
                cell_index = InsertCellTool._resolve_insert_index(
            ...
            return await self._insert_cell_file(
                ...
                cell_id=cell_id, insert_position=insert_position,
            )
    ...
    async def _insert_cell_file(
        ...
        *,
        ...
        if cell_id is not None:
            cell_index = InsertCellTool._resolve_insert_index(
                notebook.cells, cell_id=cell_id, insert_position=insert_position
            )
    ...
    async def _insert_cell_websocket(
        ...
        *,
        ...
        async with notebook_manager.get_notebook_connection(notebook_path) as notebook:
            ...
            if cell_id is not None:
                cell_index = InsertCellTool._resolve_insert_index(
                    notebook.as_dict()["cells"], cell_id=cell_id, insert_position=insert_position
                )
    ...
    async def execute(
        ...
        **kwargs
        ...
        Args:
            ...
            cell_index: Target index for insertion (0-based, -1 to append). Required if cell_id not provided.
            cell_type: Type of cell ("code", "markdown")
            cell_source: Source content for the cell
            cell_id: Stable cell ID (nbformat 4.5+) of the reference cell. Use with insert_position.
            insert_position: Insert "before" or "after" the cell identified by cell_id.
