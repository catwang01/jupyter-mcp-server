    ...
    async def _overwrite_cell_ydoc(
        ...
        *, cell_id: str = None,
        ...
        Args:
            ...
            cell_id: Optional cell ID to resolve (takes priority over cell_index)
        ...
        if nb:
            ...
            return await self._overwrite_cell_file(notebook_path, cell_index, cell_source, cell_id=cell_id)
    ...
    async def execute(
        ...
        **kwargs
        ...
        Args:
            ...
            cell_id: Stable cell ID (nbformat 4.5+). Prefer over cell_index when available.
        ...
        if mode == ServerMode.JUPYTER_SERVER and contents_manager is not None:
            ...
            if serverapp:
                ...
                diff = await self._overwrite_cell_ydoc(serverapp, notebook_path, cell_index, cell_source, cell_id=cell_id)
            else:
                # Fall back to file operations
                diff = await self._overwrite_cell_file(notebook_path, cell_index, cell_source, cell_id=cell_id)
